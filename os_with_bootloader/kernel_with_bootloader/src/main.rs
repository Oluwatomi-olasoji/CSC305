...
fn my_entry_point(boot_info: &'static mut bootloader_api::BootInfo) -> ! {
    ...
    let mut frame_buffer_writer = 
        ...
        //CA1 defining my print function
        macro_rules! print{
            ($($arg:tt)*) => ({
                use core::fmt::Write;
    ...
    print!("hey there world, this code uses a print! macro\n");

    //CA1 this code sets the position of the cusor
    frame_buffer_writer.set_pos(20,30);

   
    print!( "This prints using the print! macro with the cusor adjusted");
